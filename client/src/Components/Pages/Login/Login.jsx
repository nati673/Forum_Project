...
const Login = () => {
  ...
  const HandleIconChange = () => {
   ...
   return (
     <div className="container-fluid c login_page">
       <div className="container py-5 d-md-flex justify-content-between login_container">
         <div
           className="main col-12 col-md-6 me-md-2 p-5 d-flex flex-column justify-content-center "
         ...
         >
           ...
           <form onSubmit={handleSubmit}>
             ...
             <button className="btn1 blob-btn mbA">
               submit
         ...
         <div className="sideNote2 marlogin container dd-login col-12 col-md-6 ms-md-2  mt-sm-5">
           ...
           <button className="btn11 ">HOW IT WORKS</button>
         </div>
       </div>
     </div>
   );
